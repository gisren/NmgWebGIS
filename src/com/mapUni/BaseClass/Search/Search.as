...
package com.mapUni.BaseClass.Search
{
	...
	public class Search
	{
		 ...
		 * 
		 */		
		public function Search(layerUrl:String, qGeometry:Geometry, qWhere:String, result:Function, resultParam:Object=null, 
							   outField:Array=null, useAMF:Boolean=true, fault:Function=null, faultParam:Object=null, returnGeometry:Boolean=true):void
		{
			var queryParam:Query = getQuery(qGeometry, qWhere, outField, returnGeometry);
		 ...
		 * 
		 */		
		private function getQuery(geometry:Geometry, where:String, qOutField:Array, returnGeometry:Boolean):Query
		{
